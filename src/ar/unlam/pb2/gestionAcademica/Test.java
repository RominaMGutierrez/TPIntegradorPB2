...
public class Test {
	...
	public void queNoSePuedanAgregarAlumnosALaComisionQueNoEstenDadosDeAlta() {
		...
		assertTrue(sistema.agregarAlumnoALaComision(dniAlumno1, codigoDeComision1));
		assertTrue(sistema.agregarAlumnoALaComision(dniAlumno2, codigoDeComision2));
	}
	...
	public void queSePuedanRegistrarLasNotasDeLasMaterias() {
		...
		assertTrue(sistema.inscribirAlumnoAComision(dniAlumno1, codigoDeComision1));
		assertTrue(sistema.inscribirAlumnoAComision(dniAlumno2, codigoDeComision2));
		...
		assertTrue(sistema.registrarNota(dniAlumno2, codigoDeComision2, notaAlumno1, TipoDeParcial.PRIMER_PARCIAL));
		assertTrue(sistema.registrarNota(dniAlumno2, codigoDeComision2, notaAlumno1, TipoDeParcial.SEGUNDO_PARCIAL));
		assertTrue(sistema.registrarNota(dniAlumno2, codigoDeComision1, notaAlumno3, TipoDeParcial.PRIMER_PARCIAL));
	}
	
	@org.junit.Test
	public void queSePuedanObtenerLasLasMateriasAprobadasDelAlumno() {
		String nombreSistema = "Gestion";
		SistemaGestionAcademica sistema = new SistemaGestionAcademica(nombreSistema);
		//Agregar materias y su correlativa
		Integer codigoDeMateria1 = 1, codigoDeMateria2 = 2, codigoDeMateria3 = 3;
		...
		ArrayList<Materia> materiasss = new ArrayList<>();
		materiasss.add(materia1);
		materiasss.add(materia2);
		
		assertTrue(sistema.inscribirAlumnoAComision(dniAlumno1, codigoDeComision1));
		assertTrue(sistema.inscribirAlumnoAComision(dniAlumno1, codigoDeComision2));
		...
		assertEquals(sistema.obtenerMateriasAprobadasParaUnAlumno(dniAlumno1), materiasss);
	}
